...
def FirstNodeSettings():
	...
	if platform == "darwin":
		Add2LaunchdValidator(name="validator", user=vuser, start=validatorAppPath, arg1=cpus, arg2=globalConfigPath, arg3=tonDbDir, arg4=tonLogPath, arg5=604800, arg6=4)
	else:
...
def EnableJsonRpc():
	...
	srcDir = local.buffer.src_dir
	user = local.buffer.user
	exitCode = run_as_root(["bash", srcDir + "mytonctrl/scripts/jsonrpcinstaller.sh", "-u", user])
	if exitCode == 0:
